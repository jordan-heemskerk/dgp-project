...
namespace std {
	...
	template <typename T>
        constexpr bool operator == (const optional<T> & lhs, const optional<T> & rhs) noexcept(noexcept(std::declval<const T &>()==std::declval<const T &>())) {
	...
	template <typename T>
        constexpr bool operator == (const optional<T> & opt, const T & v) noexcept(noexcept(std::declval<const T &>()==std::declval<const T &>())) {
	...
	template <typename T>
        constexpr bool operator == (const T & value, const optional<T> & opt) noexcept(noexcept(std::declval<const T &>()==std::declval<const T &>())) {
